...
class TestVC(CreateScratchDirectoryMixin, unittest.TestCase):
    ...
    def test_new(self, mock_ls, mock_cp):
        ...
        mock_cp.assert_called_with(self.local_json_file, 's3://baiji-pod-mock-versioned-assets/new/foo.1.0.0.a', progress=False)
        vc.add("/new/foo.b", self.local_json_file, version="1.2.3")
        mock_cp.assert_called_with(self.local_json_file, 's3://baiji-pod-mock-versioned-assets/new/foo.1.2.3.b', progress=False)
        vc.add("/new/foo.c", self.local_json_file, version="1.2")
        mock_cp.assert_called_with(self.local_json_file, 's3://baiji-pod-mock-versioned-assets/new/foo.1.2.0.c', progress=False)
    ...
    def test_update(self, mock_ls, mock_cp):
        ...
        mock_cp.assert_called_with(self.local_json_file, "s3://baiji-pod-mock-versioned-assets/foo/bar.1.2.42.csv", progress=False)
        ...
        mock_cp.assert_called_with(self.local_json_file, "s3://baiji-pod-mock-versioned-assets/foo/bar.2.0.0.csv", progress=False)
        vc.update("/foo/bar.csv", self.local_json_file, major=True, min_version="3.1.1")
        mock_cp.assert_called_with(self.local_json_file, "s3://baiji-pod-mock-versioned-assets/foo/bar.3.1.1.csv", progress=False)

        vc.update_major("/foo/bar.csv", self.local_json_file)
        mock_cp.assert_called_with(self.local_json_file, "s3://baiji-pod-mock-versioned-assets/foo/bar.2.0.0.csv", progress=False)
        vc.update_minor("/foo/bar.csv", self.local_json_file)
        mock_cp.assert_called_with(self.local_json_file, "s3://baiji-pod-mock-versioned-assets/foo/bar.1.3.0.csv", progress=False)
