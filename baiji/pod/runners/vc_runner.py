class VCRunner(object):
    ...
    def _parse_args(self):
        ...
        if self.default_bucket is None:
            ...
            parser.add_argument('--bucket', default=None, type=str, help='S3 bucket name; defaults to {}'.format(self.default_bucket))

        if self.default_manifest_path is None:
            parser.add_argument('--manifest', required=True, type=str, help='Version manifest')
        else:
            parser.add_argument('--manifest', default=None, type=str, help='Version manifest; defaults to {}'.format(self.default_manifest_path))
    ...
    def main(self):
        ...
        if args.command == 'publish':
            ...
            if args.path is not None:
                ...
                print 'publish {} version {} as {}'.format(
                    args.path,
                    args.version,
                    url)
            else:
